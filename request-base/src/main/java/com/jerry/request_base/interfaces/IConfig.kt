...
import com.jerry.request_base.bean.ControllerResultMapper
...
abstract class IConfig {
    ...
    abstract fun onRequestEnd(context: Context, request: Request, response: Response, controllerResultMapper: ControllerResultMapper) :Boolean
}